...
const PREVIEW = [
  {
    competencia: "Estruturação de problemas",
    nivel: "Consolidar",
    meta: "Liderar a árvore de hipóteses de uma frente do projeto",
  },
  {
    competencia: "Modelagem e análise de dados",
    nivel: "Desenvolver",
    meta: "Construir o modelo de capacidade do diagnóstico",
  },
  {
    competencia: "Comunicação com cliente",
    nivel: "Desenvolver",
    meta: "Conduzir a reunião semanal de status com o cliente",
  },
];
        ...
        items={[
          {
            ...
            detail: "O que se espera de cada nível, de analista a gerente.",
          },
          {
            title: "Metas do ciclo",
            detail: "Poucas metas, ligadas ao projeto e ao próximo nível.",
          },
          {
            title: "Check-ins com o gestor",
            detail: "Conversas curtas e registradas ao longo do ciclo.",
          },
          {
            title: "Trilha de desenvolvimento",
            detail: "Cursos, leituras e experiências em projeto.",
          },
        ]}
      >
        <div
          aria-label="Prévia de exemplo, sem interação"
          className="flex flex-col gap-3 rounded-lg border border-dashed border-control p-4"
        >
          ...
          <div className="relative overflow-x-auto">
            <table className="w-full min-w-[300px] text-ui">
              <thead>
